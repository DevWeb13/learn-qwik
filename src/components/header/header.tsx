    ...
    <header class={`${styles.header_header} ${styles.header_sticky}`}>
      ...
      <nav class={`${styles.navbar_nav}`}>
        ...
        <div class={`${styles.navbar_links}`}>
          ...
          <a class="" title="Documentation" href="/docs">
            Docs
          </a>
          <a class="" href="/blog">
            Blog
          ...
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://vercel.com/templates/next.js?utm_source=next-site&amp;utm_medium=navbar&amp;utm_campaign=learn"
          >
            Templates
            <svg
              aria-hidden="true"
        ...
        <div class={`${styles.navbar_headerButtons}`}>
          ...
          <a
            role="link"
            tabIndex={0}
            href="https://vercel.com/new/clone?utm_source=next-site&amp;utm_medium=banner&amp;b=main&amp;s=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Fnextjs&amp;showOptionalTeamCreation=false&amp;template=nextjs&amp;teamCreateStatus=hidden&amp;utm_campaign=learn"
            type="submit"
          ...
          <a
            role="link"
            tabIndex={0}
            href="/learn?utm_source=next-site&amp;utm_medium=navbar&amp;utm_campaign=learn"
            type="submit"
            ...
            style="--geist-icon-size:16px"
          >
            <span class={`${styles.button_content}`}>Learn</span>
          </a>
        </div>
      </nav>
    </header>
