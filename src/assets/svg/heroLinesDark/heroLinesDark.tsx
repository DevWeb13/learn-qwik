...
import styles from "./heroLinesDark.module.css";

export default component$(() => {
  return (
    <svg
      class={`${styles.hero_linesDark} top-0} absolute`}
      fill="none"
      height="215"
      viewBox="0 0 460 215"
      width="460"
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.893678" stop-color="white"></stop>
        ...
        >
          <stop stop-color="white" stop-opacity="0"></stop>
          <stop offset="0.333333" stop-color="white"></stop>
        ...
        >
          ...
          <stop offset="0.5" stop-color="white" stop-opacity="0.34"></stop>
