...
export const ModalBottomSheet2026 = component$<ModalBottomSheet2026Props>(
  ({ chapters }) => {
    ...
    const store = useStore({
      completedChapters2026: useProfile().value?.completedChapters2026 || [],
    });
              ...
              <div class="flex justify-between gap-3 p-3">
                ...
                >
                  ...
                  <div class="flex flex-col items-start text-left">
                    ...
                    >
                      {store.completedChapters2026.length}/16 Chapters
                    </p>
                  </div>
                </Link>
                <button
                  ...
                  <div class="flex flex-col">
                    {chapters.map((chapter, id) => (
                      <ModalLink2026
                        ...
                        title={chapter.title}
                        uri={chapter.uri}
                        completedChapters={store.completedChapters2026}
                        active={
