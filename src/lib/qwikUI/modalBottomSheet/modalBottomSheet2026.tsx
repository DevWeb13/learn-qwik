// src/lib/qwikUI/modalBottomSheet/modalBottomSheet2026.tsx
...
import { ModalLink2026 } from "~/components/UI/modalLink/modalLink2026";
import { useProfile } from "~/routes/layout";
import type { ChapterType } from "../../../types/chapterType";

interface ModalBottomSheet2026Props {
  chapters: ChapterType[];
}

export const ModalBottomSheet2026 = component$<ModalBottomSheet2026Props>(
  ({ chapters }) => {
    ...
    const completedChapters2026 = useComputed$(
    ...
    // Ferme la modale après navigation.
    useTask$(({ track }) => {
                    ...
                    <Link href="/" class="flex min-w-0 items-center gap-3">
                      ...
                      <div class="min-w-0">
                        ...
                        <p class="mt-0.5 text-xs text-(--ds-gray-900)">
                          {hasProfile.value
                            ? `${completedChapters2026.value.length}/${chapters.length} chapters completed`
                  ...
                  <div class="flex flex-col gap-1.5 py-4">
                    {chapters.map((chapter) => (
                      <ModalLink2026
                        ...
                        title={chapter.title}
                        uri={chapter.uri}
                        completedChapters={completedChapters2026.value}
                        showCompletedState={hasProfile.value}
                        active={
